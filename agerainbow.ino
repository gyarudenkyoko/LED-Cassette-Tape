...
#define LED_PIN     0 //LEDのDINを接続しているマイコンボードのピン
#define NUM_LEDS    10 //LEDの数
#define BRIGHTNESS  128 //LEDの明るさ
#define LED_TYPE    WS2811 //LEDの種類
...
void ChangePalettePeriodically()
{
    ...
    if( lastSecond != secondHand) {
        ...
        if( secondHand == 35)  { currentPalette = RainbowStripeColors_p;   currentBlending = LINEARBLEND; }
        if( secondHand == 40)  { currentPalette = RainbowStripeColors_p;   currentBlending = LINEARBLEND; }
